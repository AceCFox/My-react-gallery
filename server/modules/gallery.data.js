const galleryItems = [
    ...
    { id: 2, path: 'images/AvatarCosplay.jpg', description: 'The summer after college, my friends and I made all the costumes from Avatar', likes:0},
    { id: 3, path: 'images/Banked.jpg', description: 'A banked track derby game I played at rollercon 2019', likes: 0 },
